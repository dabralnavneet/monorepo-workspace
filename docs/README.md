...
| Document | Contents |
|----------|----------|
| [PROJECT_OVERVIEW.md](./PROJECT_OVERVIEW.md) | What HireFlow is, the problem, features, target audience, monetization |
...
- **Shared packages**: `@hireflow/types`, `@hireflow/utils`, `@hireflow/database`
