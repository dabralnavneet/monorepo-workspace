...
export const awsSaaCurriculum: CurriculumDomain[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      { slug: 'instance-store', title: 'Instance Store', order: 26 },
      { slug: 'efs', title: 'EFS', order: 27 },
      { slug: 'fsx-windows-lustre-netapp-openzfs', title: 'FSx for Windows / Lustre / NetApp / OpenZFS', order: 28 },
      { slug: 's3-overview', title: 'S3 Overview', order: 29 },
      { slug: 's3-storage-classes', title: 'S3 Storage Classes', order: 30 },
      { slug: 's3-versioning', title: 'S3 Versioning', order: 31 },
      { slug: 's3-acl-and-resource-policies', title: 'S3 ACL and Resource Policies', order: 32 },
      { slug: 's3-static-website-hosting', title: 'S3 Static Website Hosting', order: 33 },
      { slug: 's3-pre-signed-urls', title: 'S3 Pre-Signed URLs', order: 34 },
      { slug: 's3-access-points', title: 'S3 Access Points', order: 35 },
      { slug: 'aws-backup', title: 'AWS Backup', order: 36 },
      { slug: 'elastic-disaster-recovery-storage', title: 'Elastic Disaster Recovery', order: 37 },
      { slug: 'storage-gateway', title: 'Storage Gateway', order: 38 },
    ],
  },
  {
    domain: 'Compute',
    topics: [
      { slug: 'ec2', title: 'EC2', order: 39 },
      { slug: 'ec2-image-builder', title: 'EC2 Image Builder', order: 40 },
      { slug: 'elastic-network-interfaces', title: 'Elastic Network Interfaces', order: 41 },
      { slug: 'elastic-beanstalk', title: 'Elastic Beanstalk', order: 42 },
      { slug: 'lightsail', title: 'Lightsail', order: 43 },
      { slug: 'ecs', title: 'ECS', order: 44 },
      { slug: 'eks', title: 'EKS', order: 45 },
      { slug: 'ecr', title: 'ECR', order: 46 },
      { slug: 'app-runner', title: 'App Runner', order: 47 },
      { slug: 'batch', title: 'Batch', order: 48 },
      { slug: 'lambda', title: 'Lambda', order: 49 },
      { slug: 'serverless-application-model', title: 'Serverless Application Model', order: 50 },
      { slug: 'amplify', title: 'Amplify', order: 51 },
      { slug: 'outposts', title: 'Outposts', order: 52 },
      { slug: 'ecs-eks-anywhere', title: 'ECS/EKS Anywhere', order: 53 },
      { slug: 'vmware-cloud-on-aws', title: 'VMware Cloud on AWS', order: 54 },
      { slug: 'snow-family-compute', title: 'The Snow Family (Compute)', order: 55 },
    ],
  },
  {
    domain: 'Database',
