...
2. **Shared types first** — All interfaces/enums shared between frontend and backend go in `@callbackos/types`.
...
import { InterviewStage } from '@callbackos/types';
...
import { PrismaClient } from '@callbackos/database';
...
- Return consistent response shapes using `ApiResponse<T>` from `@callbackos/types`
...
// 2. Monorepo packages
import { User, InterviewStage } from '@callbackos/types';
import { formatRelativeDate } from '@callbackos/utils';
import { PrismaClient } from '@callbackos/database';
